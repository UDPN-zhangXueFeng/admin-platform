...
const moduleRegistry: Record<string, ModuleEntry> = {
  user: {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.manifest),
    pages: {
      list: () =>
  ...
  'key-management': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.manifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  'wallet-type': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.walletTypeManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  'user-wallet': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.userWalletManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  'operational-wallet': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then(
  ...
  accrual: {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.accrualManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  settlement: {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.settlementManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  node: {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.nodeManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  'fx-rate': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.fxRateManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  'rd-bridge': {
    manifest: () =>
      import('@myorg/modules/td-admin/feature').then((m) => m.rdBridgeManifest),
    pages: {
      list: () =>
        import('@myorg/modules/td-admin/feature').then((m) => ({
  ...
  rule: {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.ruleManifest),
    pages: {
      list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.RuleListPage as unknown as ComponentType<unknown> })),
      detail: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.RuleDetailPage as unknown as ComponentType<unknown> })),
      edit: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.RuleEditPage as unknown as ComponentType<unknown> })),
      create: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.RuleEditPage as unknown as ComponentType<unknown> })),
      t_edit: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.RuleTEditPage as unknown as ComponentType<unknown> })),
    },
  },
  'transaction-monitoring': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.transactionMonitoringManifest),
    pages: {
      list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.TransactionMonitoringListPage as unknown as ComponentType<unknown> })),
      detail: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.TransactionMonitoringDetailPage as unknown as ComponentType<unknown> })),
    },
  },
  'screening-providers': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.screeningProvidersManifest),
    pages: {
      list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.ScreeningProvidersPage as unknown as ComponentType<unknown> })),
    },
  },
  'statistics-reports': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.statisticsReportsManifest),
    pages: { list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.StatisticsReportsPage as unknown as ComponentType<unknown> })) },
  },
  'account-manage': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.accountManageManifest),
    pages: {
      list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.AccountManagePage as unknown as ComponentType<unknown> })),
      detail: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.AccountRegisterPage as unknown as ComponentType<unknown> })),
    },
  },
  'statistic-analysis': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.statisticAnalysisManifest),
    pages: { list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.StatisticAnalysisPage as unknown as ComponentType<unknown> })) },
  },
  'transaction-flow': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.transactionFlowManifest),
    pages: { list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.TransactionFlowPage as unknown as ComponentType<unknown> })) },
  },
  'data-export': {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.dataExportManifest),
    pages: { list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.DataExportPage as unknown as ComponentType<unknown> })) },
  },
  networks: {
    manifest: () => import('@myorg/modules/td-admin/feature').then((m) => m.networksManifest),
    pages: { list: () => import('@myorg/modules/td-admin/feature').then((m) => ({ default: m.NetworksPage as unknown as ComponentType<unknown> })) },
  },
};
