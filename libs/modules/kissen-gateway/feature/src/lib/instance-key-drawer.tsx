...
/** PEM 展示块（源 .pem：mono、break-all、pre-wrap、限高滚动）。 */
        ...
        <div className="flex flex-col gap-3.5">
          {viewQuery.isLoading ? (
            ...
            <>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Uplink Key Pair (generated by this instance)</CardTitle>
                </CardHeader>
                <CardContent>
                  <dl className="space-y-1.5">
                    ...
                    <div className="flex flex-wrap gap-x-2 gap-y-0.5">
                      ...
                      <dd className="min-w-0 flex-1 break-all font-mono text-xs">
                        {orDash(view.uplinkPrivateKeyFingerprint)}
                      </dd>
                    </div>
                    <div className="flex flex-wrap gap-x-2 gap-y-0.5">
                      <dt className="text-xs text-muted-foreground">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Downlink Public Key (delivered by management side)</CardTitle>
                </CardHeader>
                <CardContent>
                  <dl className="space-y-1.5">
                    <div className="flex flex-wrap gap-x-2 gap-y-0.5">
                      ...
                      <dd className="min-w-0 flex-1 break-all font-mono text-xs">
                        {orDash(view.downlinkFingerprint)}
                      </dd>
                    </div>
                    <div className="flex flex-wrap gap-x-2 gap-y-0.5">
                      <dt className="text-xs text-muted-foreground">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Access &amp; Reset</CardTitle>
                </CardHeader>
                <CardContent>
