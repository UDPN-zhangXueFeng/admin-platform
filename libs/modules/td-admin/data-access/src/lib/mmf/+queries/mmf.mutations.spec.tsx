jest.mock('@myorg/shared/data-access-api', () => require('../__mocks__/data-access-api.stub'));
/**
...
import { setResponse } from '../__mocks__/data-access-api.stub';
...
describe('useApplyAccrualMutation', () => {
  ...
  it('does not invalidate when the apply fails (no spurious refresh)', async () => {
    ...
    await act(async () => {
      ...
      const { apiClient } = await import('../__mocks__/data-access-api.stub');
      const postSpy = jest
