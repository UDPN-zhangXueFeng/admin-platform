...
import { useCoinList, useStatistics, useTrendData, useTrendTzData } from '@myorg/modules/td-admin/data-access';
import type { CoinData } from '@myorg/modules/td-admin/data-access';
