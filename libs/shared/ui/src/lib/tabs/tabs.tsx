 ...
 *
 * Provides a flex row with bottom border and muted background.
 ...
 *
 * Styled as a pill inside the list. Active state receives
 * `bg-background text-foreground shadow` to pop forward.
 */
 ...
 *
 * Only rendered when its associated trigger is active.
